...
class pointsRepository:
        ...
        if initialPoints is not None:
            ...
            for points in initialPoints:
                if isinstance(points, MyPoint):
                    self.__list_of_points.append(points)
    ...
    def getPointsSquare(self, up_left_x, up_left_y, length):
        #ex. 5
        #Get all points that are in a given square, check length > 0
        down_right_y = up_left_y - length
    ...
    def delPointByIndex(self, index):
        ...
        if (h.checkindex(index)):
            ...
            raise IndexError("Index input incorrect!")


    def delPointsSquare(self, up_left_x, up_left_y, length):
...
print(pr.getPointAtIndex(1))
# print(pr.getPoints())
# print(pr.getPointsColor('red'))
# print(pr.getPointsSquare(1, 900, 900, 1))
